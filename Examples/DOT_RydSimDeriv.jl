...
function Evolution_Ω( 𝑇   ::μs_t{ℚ}
                      ;
                      𝛥   ::Rad_per_μs_t,
                      ε   ::ℝ,
                      hw  ::HW_Descr     ) ::Evolution_Ω
	...
	Δ_𝑡ᵒⁿ  = 𝛥𝑡ₘᵢₙ
    Δ_𝑡ᵒᶠᶠ = 𝑡ᵒᶠᶠₘₐₓ - get_hw_𝑡ᵒᶠᶠ⁻ᵈⁱᶠᶠ𝛥𝛺(hw;𝛺=𝛺ₘₐₓ, 𝛥)
...
function Evolution_Δ( 𝑇   ::μs_t{ℚ}
                      ;
                      𝛺   ::Rad_per_μs_t,
                      ε   ::ℝ,
                      hw  ::HW_Descr     ) ::Evolution_Δ
    ...
    Ω_𝑡ᵒⁿ  = 𝛥𝑡ₘᵢₙ
    Ω_𝑡ᵒᶠᶠ = 𝑡ᵒᶠᶠₘₐₓ + get_hw_𝑡ᵒᶠᶠ⁻ᵈⁱᶠᶠ𝛥𝛺(hw;𝛺, 𝛥=𝛥ₘₐₓ)
...
evf(ev::Evolution,
    ϕ ::Vector{ℂ},
    R ::Hermitian{ℂ,Matrix{ℂ}},
    ψ ::Vector{ℂ}               ; kwargs... ) ::ℝ   = 1 - 2⋅abs²( ev(ϕ,R,ψ;kwargs...) )
